...
public class Exercises1 extends AppCompatActivity {
    ...
    private static String OnDestroySave;
    ...
    private void logAndAppend(String lifecycleEvent) {
        ...
        //myApp.setLifecycleDisplay(mLifecycleDisplay.getText().toString());
    }
    ...
    protected void onDestroy() {
        ...
        OnDestroySave = mLifecycleDisplay.getText().toString();
    }
